...
WebUI.verifyElementPresent(findTestObject('Login/span_Password_required'), 10)

WebUI.verifyElementText(findTestObject('Login/span_Password_required'), findTestData('TestDataLogin').getValue('MessageError', 
        2))
